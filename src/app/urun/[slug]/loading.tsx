...
export default function UrunLoading() {
  return (
    <>
      ...
      <main>
        {/* Breadcrumb */}
        <div style={{ backgroundColor: 'var(--color-surface)', borderBottom: '1px solid var(--color-hairline-light)' }}>
          <div className="px-margin" style={{ maxWidth: '1200px', margin: '0 auto', paddingTop: '14px', paddingBottom: '14px' }}>
            <SkeletonBox width={280} height={10} />
          </div>
        </div>

        {/* Ana ürün bölümü */}
        <section style={{ backgroundColor: 'var(--color-surface)', paddingTop: 'clamp(28px, 6vw, 48px)', paddingBottom: 'clamp(40px, 10vw, 80px)' }}>
          <div className="px-margin" style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            >
              ...
              <div>
                ...
                <SkeletonBox width={36} height={1} style={{ marginBottom: '28px', background: 'var(--color-charcoal-pure)' }} />
                ...
                {/* Meta */}
                <div style={{ borderTop: '1px solid var(--color-hairline-light)', paddingTop: '24px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
        ...
        <section style={{ backgroundColor: 'var(--color-surface-container-low)', paddingTop: '64px', paddingBottom: '64px', borderTop: '1px solid var(--color-hairline-light)' }}>
          <div className="px-margin" style={{ maxWidth: '760px', margin: '0 auto' }}>
