    ...
    >
      ...
      >
        ...
        <InfoBox title="Telefon">
          <a href="tel:+902241234567" style={{ color: 'var(--color-gold)', textDecoration: 'none' }}>
            +90 224 123 45 67
          </a>
          <br />
          <span style={{ fontSize: '12px', color: 'var(--color-cream-faint)' }}>Hafta içi 09:00 - 18:00</span>
        </InfoBox>

        <InfoBox title="E-posta">
          Genel:{' '}
          <a href="mailto:bilgi@drsenol.shop" style={{ color: 'var(--color-gold)', textDecoration: 'none' }}>
            bilgi@drsenol.shop
          </a>
          <br />
          Sipariş:{' '}
          ...
          <br />
          Basın:{' '}
          <a href="mailto:basin@drsenol.shop" style={{ color: 'var(--color-gold)', textDecoration: 'none' }}>
            basin@drsenol.shop
          </a>
        </InfoBox>
        ...
        <InfoBox title="WhatsApp">
          ...
          <br />
          <span style={{ fontSize: '12px', color: 'var(--color-cream-faint)' }}>
      ...
      <P>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          style={{ color: 'var(--color-gold)', textDecoration: 'none', marginRight: '24px' }}
        >
          Instagram
        </a>
        <a
