...
export default function UyelikSozlesmesiPage() {
  ...
  return (
    ...
    >
      ...
      <P>
        İşbu Üyelik Sözleşmesi (&ldquo;Sözleşme&rdquo;), <strong style={{ color: 'var(--color-on-surface)' }}>{co.legal_name}</strong> (&ldquo;{co.trade_name}&rdquo;)
        ile <a href={co.website} style={{ color: 'var(--color-honey-amber)' }}>{co.website}</a> sitesine üye olan gerçek/tüzel kişi (&ldquo;Üye&rdquo;) arasında
