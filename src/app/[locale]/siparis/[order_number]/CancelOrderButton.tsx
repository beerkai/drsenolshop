...
export default function CancelOrderButton({ orderNumber, email }: Props) {
  ...
  return (
    ...
    >
      ...
      {error && (
        <div role="alert" style={{ padding: '10px 12px', border: '1px solid var(--color-error)', backgroundColor: 'rgba(200,71,45,0.1)', color: 'var(--color-on-surface)', fontSize: '13px', marginBottom: '14px' }}>
          {error}
        </div>
      )}
