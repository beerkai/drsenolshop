...
export default async function LocaleLayout({
  ...
  // next-intl'in AsyncLocalStorage context'i — getHomeContent() içindeki
  // getLocale() de dahil, bu request'in geri kalanı bunu okur.
  setRequestLocale(locale);

  // Katalog etiketleri tema editöründen gelir; istek başına tek okuma (cache)
  const [{ productLabels }, messages] = await Promise.all([getHomeContent(), getMessages()]);
