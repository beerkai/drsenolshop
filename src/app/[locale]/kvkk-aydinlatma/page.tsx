...
export const metadata: Metadata = {
  title: 'KVKK Aydınlatma Metni · Dr. Şenol Shop',
  description:
    '6698 sayılı KVKK kapsamında kişisel verilerin işlenmesi, aktarımı ve ilgili kişi hakları hakkında aydınlatma metni.',
}
...
export default function KvkkAydinlatmaPage() {
  ...
  return (
    ...
    >
      ...
      <P>
        Sipariş ve fatura kayıtları Vergi Usul Kanunu ile Türk Ticaret Kanunu uyarınca{' '}
        <strong style={{ color: 'var(--color-on-surface)' }}>10 yıl</strong> saklanır. Hesap verileriniz, hesabınızı
        silmediğiniz sürece üyeliğiniz boyunca tutulur. Pazarlama izinleri izninizi geri çekene kadar geçerlidir.
      </P>
